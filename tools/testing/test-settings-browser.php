<?php
/**
 * Testare Setări Clinica - Browser
 * Accesează: http://localhost/plm/wp-content/plugins/clinica/test-settings-browser.php
 */
...
if (class_exists('Clinica_Settings')) {
    ...
    echo "<p><strong>Durătă programări:</strong> " . esc_html($appointment_duration) . " minute</p>";
