<?php
/**
 * Test simplu pentru programul de lucru
 */

echo "<h1>Test Simplu Program de Lucru</h1>";

// Simulează datele din baza de date
$working_hours = array(
...
echo "<h2>1. Verificare Date</h2>";
echo "<pre>";
print_r($working_hours);
echo "</pre>";

echo "<h2>2. Test Afișare HTML</h2>";
?>
<!DOCTYPE html>
<html lang="ro">
<head>
    ...
    <title>Test Simplu Working Hours</title>
...
<body>
    <div class="test-container">
        <h1>Test Simplu Working Hours</h1>
