<?php
/**
 * Script pentru testarea query-ului din invalid-emails.php fără JOIN-urile pentru usermeta
 */
...
echo "<h2>Test Query din invalid-emails.php fără JOIN-uri pentru usermeta</h2>";
...
// QUERY fără JOIN-uri pentru usermeta
$query = "
