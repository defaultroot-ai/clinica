...
echo "=== ACTUALIZARE VALIDARE TELEFOANE CU TOATE FORMATELE ROMÂNEȘTI ===\n\n";
...
function validatePhoneWithAllFormats($phone) {
    ...
    // 1. România: +40, +4, 0, 4 urmat de 9 cifre (cu sau fără separatori)
    // 2. Ucraina: +380 urmat de 9 cifre
    // 3. Internațional: + urmat de 10-15 cifre
    
    // Format românesc fără separatori: 07xxxxxxxx, +407xxxxxxxx, +47xxxxxxxx, 47xxxxxxxx
    if (preg_match('/^(\+40|\+4|0|4)[0-9]{9}$/', $phone)) {
        return true; // Format românesc fără separatori
    }
    
    // Format românesc cu puncte: 07xx.xxx.xxx, +407xx.xxx.xxx, +47xx.xxx.xxx, 47xx.xxx.xxx
    if (preg_match('/^(\+40|\+4|0|4)[0-9]{3}\.[0-9]{3}\.[0-9]{3}$/', $phone)) {
        return true; // Format românesc cu puncte
    }
    
    // Format românesc cu liniuțe: 07xx-xxx-xxx, +407xx-xxx-xxx, +47xx-xxx-xxx, 47xx-xxx-xxx
    if (preg_match('/^(\+40|\+4|0|4)[0-9]{3}-[0-9]{3}-[0-9]{3}$/', $phone)) {
...
function getPhoneCountry($phone) {
    ...
    if (preg_match('/^(\+40|\+4|0|4)/', $clean_phone)) {
        return 'ROMANIA';
    }
...
echo "✅ Funcții de validare actualizate pentru toate formatele românești\n\n";

// Testează funcțiile cu exemple
$test_phones = array(
    '0756248957',      // România fără separatori (0)
    '0756.248.957',    // România cu puncte (0)
    '0756-248-957',    // România cu liniuțe (0)
    '+40756248957',    // România internațional (+40)
    '+40756.248.957',  // România internațional cu puncte (+40)
    '+40756-248-957',  // România internațional cu liniuțe (+40)
    '+4756248957',     // România scurt (+4)
    '+4756.248.957',   // România scurt cu puncte (+4)
    '+4756-248-957',   // România scurt cu liniuțe (+4)
    '4756248957',      // România fără + (4)
    '4756.248.957',    // România fără + cu puncte (4)
    '4756-248-957',    // România fără + cu liniuțe (4)
...
echo "   - +407XX.XXX.XXX (internațional cu puncte)\n";
echo "   - +407XX-XXX-XXX (internațional cu liniuțe)\n";
echo "   - +47XXXXXXXX (scurt)\n";
echo "   - +47XX.XXX.XXX (scurt cu puncte)\n";
echo "   - +47XX-XXX-XXX (scurt cu liniuțe)\n";
echo "   - 47XXXXXXXX (fără +)\n";
echo "   - 47XX.XXX.XXX (fără + cu puncte)\n";
echo "   - 47XX-XXX-XXX (fără + cu liniuțe)\n";
echo "\n🇺🇦 Ucraina:\n";
